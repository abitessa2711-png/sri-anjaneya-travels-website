      ...
      <section id="contact" className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 bg-transparent">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="lg:col-span-7 h-[320px] rounded-xl overflow-hidden shadow-md border border-slate-100 bg-slate-50">
            <iframe 
              src="https://maps.google.com/maps?q=Sri%20Anjaneya%20Tour%E2%80%99s%20%26%20Travels,%2061,%20Illupur%20Main%20Rd,%20Sangillyandapuram,%20Tiruchirappalli,%20Tamil%20Nadu%20620020&t=&z=16&ie=UTF8&iwloc=&output=embed" 
              width="100%" 
              height="100%" 
              style={{ border: 0 }} 
